...
func NewRendimientoEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *RendimientoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RendimientoEntity) GetName() string { return e.name }
...
func (e *RendimientoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RendimientoEntity) Deleted() bool {
	return e.deleted
}


func (e *RendimientoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRendimientoEntity(e.client, opts)
}

func (e *RendimientoEntity) Data(args ...any) any {
...
func (e *RendimientoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rendimiento; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RendimientoEntity) DataTyped(data ...Rendimiento) Rendimiento {
	if len(data) > 0 {
		return typedFrom[Rendimiento](e.Data(asMap(data[0])))
	}
	return typedFrom[Rendimiento](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rendimiento (all fields
// optional at the wire level).
func (e *RendimientoEntity) MatchTyped(match ...Rendimiento) Rendimiento {
	if len(match) > 0 {
		return typedFrom[Rendimiento](e.Match(asMap(match[0])))
	}
	return typedFrom[Rendimiento](e.Match())
}
...
func (e *RendimientoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RendimientoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RendimientoLoadMatch and returns an Rendimiento. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RendimientoEntity) LoadTyped(reqmatch RendimientoLoadMatch, ctrl map[string]any) (Rendimiento, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Rendimiento{}, err
	}
	return typedFrom[Rendimiento](res), nil
}



func (e *RendimientoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RendimientoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RendimientoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RendimientoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RendimientoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
