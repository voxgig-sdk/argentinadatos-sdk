...
type EntidadRendimientoEntity struct {
	name    string
...
func NewEntidadRendimientoEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *EntidadRendimientoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EntidadRendimientoEntity) GetName() string { return e.name }
...
func (e *EntidadRendimientoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EntidadRendimientoEntity) Deleted() bool {
	return e.deleted
}


func (e *EntidadRendimientoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntidadRendimientoEntity(e.client, opts)
}

func (e *EntidadRendimientoEntity) Data(args ...any) any {
...
func (e *EntidadRendimientoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EntidadRendimiento; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EntidadRendimientoEntity) DataTyped(data ...EntidadRendimiento) EntidadRendimiento {
	if len(data) > 0 {
		return typedFrom[EntidadRendimiento](e.Data(asMap(data[0])))
	}
	return typedFrom[EntidadRendimiento](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EntidadRendimiento (all fields
// optional at the wire level).
func (e *EntidadRendimientoEntity) MatchTyped(match ...EntidadRendimiento) EntidadRendimiento {
	if len(match) > 0 {
		return typedFrom[EntidadRendimiento](e.Match(asMap(match[0])))
	}
	return typedFrom[EntidadRendimiento](e.Match())
}
...
func (e *EntidadRendimientoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EntidadRendimientoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EntidadRendimientoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EntidadRendimientoListMatch and returns []EntidadRendimiento. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EntidadRendimientoEntity) ListTyped(reqmatch EntidadRendimientoListMatch, ctrl map[string]any) ([]EntidadRendimiento, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EntidadRendimiento](res), nil
}



func (e *EntidadRendimientoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EntidadRendimientoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EntidadRendimientoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EntidadRendimientoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
