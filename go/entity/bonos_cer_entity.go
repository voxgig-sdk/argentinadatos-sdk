...
func NewBonosCerEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *BonosCerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BonosCerEntity) GetName() string { return e.name }
...
func (e *BonosCerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BonosCerEntity) Deleted() bool {
	return e.deleted
}


func (e *BonosCerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBonosCerEntity(e.client, opts)
}

func (e *BonosCerEntity) Data(args ...any) any {
...
func (e *BonosCerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BonosCer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BonosCerEntity) DataTyped(data ...BonosCer) BonosCer {
	if len(data) > 0 {
		return typedFrom[BonosCer](e.Data(asMap(data[0])))
	}
	return typedFrom[BonosCer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BonosCer (all fields
// optional at the wire level).
func (e *BonosCerEntity) MatchTyped(match ...BonosCer) BonosCer {
	if len(match) > 0 {
		return typedFrom[BonosCer](e.Match(asMap(match[0])))
	}
	return typedFrom[BonosCer](e.Match())
}
...
func (e *BonosCerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BonosCerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BonosCerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BonosCerListMatch and returns []BonosCer. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BonosCerEntity) ListTyped(reqmatch BonosCerListMatch, ctrl map[string]any) ([]BonosCer, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[BonosCer](res), nil
}



func (e *BonosCerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BonosCerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BonosCerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BonosCerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
