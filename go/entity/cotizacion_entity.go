...
func NewCotizacionEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *CotizacionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CotizacionEntity) GetName() string { return e.name }
...
func (e *CotizacionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CotizacionEntity) Deleted() bool {
	return e.deleted
}


func (e *CotizacionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCotizacionEntity(e.client, opts)
}

func (e *CotizacionEntity) Data(args ...any) any {
...
func (e *CotizacionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cotizacion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CotizacionEntity) DataTyped(data ...Cotizacion) Cotizacion {
	if len(data) > 0 {
		return typedFrom[Cotizacion](e.Data(asMap(data[0])))
	}
	return typedFrom[Cotizacion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cotizacion (all fields
// optional at the wire level).
func (e *CotizacionEntity) MatchTyped(match ...Cotizacion) Cotizacion {
	if len(match) > 0 {
		return typedFrom[Cotizacion](e.Match(asMap(match[0])))
	}
	return typedFrom[Cotizacion](e.Match())
}
...
func (e *CotizacionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CotizacionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CotizacionLoadMatch and returns an Cotizacion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CotizacionEntity) LoadTyped(reqmatch CotizacionLoadMatch, ctrl map[string]any) (Cotizacion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cotizacion{}, err
	}
	return typedFrom[Cotizacion](res), nil
}




func (e *CotizacionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CotizacionListMatch and returns []Cotizacion. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CotizacionEntity) ListTyped(reqmatch CotizacionListMatch, ctrl map[string]any) ([]Cotizacion, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cotizacion](res), nil
}



func (e *CotizacionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CotizacionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CotizacionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CotizacionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
