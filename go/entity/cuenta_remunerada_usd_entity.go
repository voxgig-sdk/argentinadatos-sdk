...
type CuentaRemuneradaUsdEntity struct {
	name    string
...
func NewCuentaRemuneradaUsdEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *CuentaRemuneradaUsdEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CuentaRemuneradaUsdEntity) GetName() string { return e.name }
...
func (e *CuentaRemuneradaUsdEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CuentaRemuneradaUsdEntity) Deleted() bool {
	return e.deleted
}


func (e *CuentaRemuneradaUsdEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCuentaRemuneradaUsdEntity(e.client, opts)
}

func (e *CuentaRemuneradaUsdEntity) Data(args ...any) any {
...
func (e *CuentaRemuneradaUsdEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CuentaRemuneradaUsd; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CuentaRemuneradaUsdEntity) DataTyped(data ...CuentaRemuneradaUsd) CuentaRemuneradaUsd {
	if len(data) > 0 {
		return typedFrom[CuentaRemuneradaUsd](e.Data(asMap(data[0])))
	}
	return typedFrom[CuentaRemuneradaUsd](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CuentaRemuneradaUsd (all fields
// optional at the wire level).
func (e *CuentaRemuneradaUsdEntity) MatchTyped(match ...CuentaRemuneradaUsd) CuentaRemuneradaUsd {
	if len(match) > 0 {
		return typedFrom[CuentaRemuneradaUsd](e.Match(asMap(match[0])))
	}
	return typedFrom[CuentaRemuneradaUsd](e.Match())
}
...
func (e *CuentaRemuneradaUsdEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CuentaRemuneradaUsdEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CuentaRemuneradaUsdEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CuentaRemuneradaUsdListMatch and returns []CuentaRemuneradaUsd. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CuentaRemuneradaUsdEntity) ListTyped(reqmatch CuentaRemuneradaUsdListMatch, ctrl map[string]any) ([]CuentaRemuneradaUsd, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CuentaRemuneradaUsd](res), nil
}



func (e *CuentaRemuneradaUsdEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CuentaRemuneradaUsdEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CuentaRemuneradaUsdEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CuentaRemuneradaUsdEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
