...
func NewCriptopesoEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *CriptopesoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CriptopesoEntity) GetName() string { return e.name }
...
func (e *CriptopesoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CriptopesoEntity) Deleted() bool {
	return e.deleted
}


func (e *CriptopesoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCriptopesoEntity(e.client, opts)
}

func (e *CriptopesoEntity) Data(args ...any) any {
...
func (e *CriptopesoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Criptopeso; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CriptopesoEntity) DataTyped(data ...Criptopeso) Criptopeso {
	if len(data) > 0 {
		return typedFrom[Criptopeso](e.Data(asMap(data[0])))
	}
	return typedFrom[Criptopeso](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Criptopeso (all fields
// optional at the wire level).
func (e *CriptopesoEntity) MatchTyped(match ...Criptopeso) Criptopeso {
	if len(match) > 0 {
		return typedFrom[Criptopeso](e.Match(asMap(match[0])))
	}
	return typedFrom[Criptopeso](e.Match())
}
...
func (e *CriptopesoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CriptopesoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CriptopesoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CriptopesoListMatch and returns []Criptopeso. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CriptopesoEntity) ListTyped(reqmatch CriptopesoListMatch, ctrl map[string]any) ([]Criptopeso, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Criptopeso](res), nil
}



func (e *CriptopesoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CriptopesoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CriptopesoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CriptopesoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
