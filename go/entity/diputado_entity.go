...
func NewDiputadoEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *DiputadoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DiputadoEntity) GetName() string { return e.name }
...
func (e *DiputadoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DiputadoEntity) Deleted() bool {
	return e.deleted
}


func (e *DiputadoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDiputadoEntity(e.client, opts)
}

func (e *DiputadoEntity) Data(args ...any) any {
...
func (e *DiputadoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DiputadoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DiputadoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *DiputadoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DiputadoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DiputadoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DiputadoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
