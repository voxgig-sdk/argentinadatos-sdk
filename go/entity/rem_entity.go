...
func NewRemEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *RemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RemEntity) GetName() string { return e.name }
...
func (e *RemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RemEntity) Deleted() bool {
	return e.deleted
}


func (e *RemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRemEntity(e.client, opts)
}

func (e *RemEntity) Data(args ...any) any {
...
func (e *RemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RemEntity) DataTyped(data ...Rem) Rem {
	if len(data) > 0 {
		return typedFrom[Rem](e.Data(asMap(data[0])))
	}
	return typedFrom[Rem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rem (all fields
// optional at the wire level).
func (e *RemEntity) MatchTyped(match ...Rem) Rem {
	if len(match) > 0 {
		return typedFrom[Rem](e.Match(asMap(match[0])))
	}
	return typedFrom[Rem](e.Match())
}
...
func (e *RemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RemEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RemEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RemListMatch and returns []Rem. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RemEntity) ListTyped(reqmatch RemListMatch, ctrl map[string]any) ([]Rem, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Rem](res), nil
}



func (e *RemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
