...
func NewIndiceUvaEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *IndiceUvaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IndiceUvaEntity) GetName() string { return e.name }
...
func (e *IndiceUvaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IndiceUvaEntity) Deleted() bool {
	return e.deleted
}


func (e *IndiceUvaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIndiceUvaEntity(e.client, opts)
}

func (e *IndiceUvaEntity) Data(args ...any) any {
...
func (e *IndiceUvaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IndiceUva; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IndiceUvaEntity) DataTyped(data ...IndiceUva) IndiceUva {
	if len(data) > 0 {
		return typedFrom[IndiceUva](e.Data(asMap(data[0])))
	}
	return typedFrom[IndiceUva](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IndiceUva (all fields
// optional at the wire level).
func (e *IndiceUvaEntity) MatchTyped(match ...IndiceUva) IndiceUva {
	if len(match) > 0 {
		return typedFrom[IndiceUva](e.Match(asMap(match[0])))
	}
	return typedFrom[IndiceUva](e.Match())
}
...
func (e *IndiceUvaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IndiceUvaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *IndiceUvaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IndiceUvaListMatch and returns []IndiceUva. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *IndiceUvaEntity) ListTyped(reqmatch IndiceUvaListMatch, ctrl map[string]any) ([]IndiceUva, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[IndiceUva](res), nil
}



func (e *IndiceUvaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IndiceUvaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IndiceUvaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IndiceUvaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
