...
type TasaPlazoFijoEntity struct {
	name    string
...
func NewTasaPlazoFijoEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *TasaPlazoFijoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TasaPlazoFijoEntity) GetName() string { return e.name }
...
func (e *TasaPlazoFijoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TasaPlazoFijoEntity) Deleted() bool {
	return e.deleted
}


func (e *TasaPlazoFijoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTasaPlazoFijoEntity(e.client, opts)
}

func (e *TasaPlazoFijoEntity) Data(args ...any) any {
...
func (e *TasaPlazoFijoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TasaPlazoFijo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TasaPlazoFijoEntity) DataTyped(data ...TasaPlazoFijo) TasaPlazoFijo {
	if len(data) > 0 {
		return typedFrom[TasaPlazoFijo](e.Data(asMap(data[0])))
	}
	return typedFrom[TasaPlazoFijo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TasaPlazoFijo (all fields
// optional at the wire level).
func (e *TasaPlazoFijoEntity) MatchTyped(match ...TasaPlazoFijo) TasaPlazoFijo {
	if len(match) > 0 {
		return typedFrom[TasaPlazoFijo](e.Match(asMap(match[0])))
	}
	return typedFrom[TasaPlazoFijo](e.Match())
}
...
func (e *TasaPlazoFijoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TasaPlazoFijoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TasaPlazoFijoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TasaPlazoFijoListMatch and returns []TasaPlazoFijo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TasaPlazoFijoEntity) ListTyped(reqmatch TasaPlazoFijoListMatch, ctrl map[string]any) ([]TasaPlazoFijo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TasaPlazoFijo](res), nil
}



func (e *TasaPlazoFijoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TasaPlazoFijoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TasaPlazoFijoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TasaPlazoFijoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
