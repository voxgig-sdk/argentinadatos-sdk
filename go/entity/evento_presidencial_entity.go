...
type EventoPresidencialEntity struct {
	name    string
...
func NewEventoPresidencialEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *EventoPresidencialEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventoPresidencialEntity) GetName() string { return e.name }
...
func (e *EventoPresidencialEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EventoPresidencialEntity) Deleted() bool {
	return e.deleted
}


func (e *EventoPresidencialEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEventoPresidencialEntity(e.client, opts)
}

func (e *EventoPresidencialEntity) Data(args ...any) any {
...
func (e *EventoPresidencialEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EventoPresidencial; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EventoPresidencialEntity) DataTyped(data ...EventoPresidencial) EventoPresidencial {
	if len(data) > 0 {
		return typedFrom[EventoPresidencial](e.Data(asMap(data[0])))
	}
	return typedFrom[EventoPresidencial](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EventoPresidencial (all fields
// optional at the wire level).
func (e *EventoPresidencialEntity) MatchTyped(match ...EventoPresidencial) EventoPresidencial {
	if len(match) > 0 {
		return typedFrom[EventoPresidencial](e.Match(asMap(match[0])))
	}
	return typedFrom[EventoPresidencial](e.Match())
}
...
func (e *EventoPresidencialEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EventoPresidencialEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EventoPresidencialEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EventoPresidencialListMatch and returns []EventoPresidencial. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EventoPresidencialEntity) ListTyped(reqmatch EventoPresidencialListMatch, ctrl map[string]any) ([]EventoPresidencial, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EventoPresidencial](res), nil
}



func (e *EventoPresidencialEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EventoPresidencialEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EventoPresidencialEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EventoPresidencialEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
