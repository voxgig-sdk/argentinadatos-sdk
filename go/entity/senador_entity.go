...
func NewSenadorEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *SenadorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SenadorEntity) GetName() string { return e.name }
...
func (e *SenadorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SenadorEntity) Deleted() bool {
	return e.deleted
}


func (e *SenadorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSenadorEntity(e.client, opts)
}

func (e *SenadorEntity) Data(args ...any) any {
...
func (e *SenadorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Senador; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SenadorEntity) DataTyped(data ...Senador) Senador {
	if len(data) > 0 {
		return typedFrom[Senador](e.Data(asMap(data[0])))
	}
	return typedFrom[Senador](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Senador (all fields
// optional at the wire level).
func (e *SenadorEntity) MatchTyped(match ...Senador) Senador {
	if len(match) > 0 {
		return typedFrom[Senador](e.Match(asMap(match[0])))
	}
	return typedFrom[Senador](e.Match())
}
...
func (e *SenadorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SenadorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SenadorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SenadorListMatch and returns []Senador. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SenadorEntity) ListTyped(reqmatch SenadorListMatch, ctrl map[string]any) ([]Senador, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Senador](res), nil
}



func (e *SenadorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SenadorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SenadorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SenadorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
