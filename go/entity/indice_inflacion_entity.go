...
type IndiceInflacionEntity struct {
	name    string
...
func NewIndiceInflacionEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *IndiceInflacionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IndiceInflacionEntity) GetName() string { return e.name }
...
func (e *IndiceInflacionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IndiceInflacionEntity) Deleted() bool {
	return e.deleted
}


func (e *IndiceInflacionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIndiceInflacionEntity(e.client, opts)
}

func (e *IndiceInflacionEntity) Data(args ...any) any {
...
func (e *IndiceInflacionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IndiceInflacion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IndiceInflacionEntity) DataTyped(data ...IndiceInflacion) IndiceInflacion {
	if len(data) > 0 {
		return typedFrom[IndiceInflacion](e.Data(asMap(data[0])))
	}
	return typedFrom[IndiceInflacion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IndiceInflacion (all fields
// optional at the wire level).
func (e *IndiceInflacionEntity) MatchTyped(match ...IndiceInflacion) IndiceInflacion {
	if len(match) > 0 {
		return typedFrom[IndiceInflacion](e.Match(asMap(match[0])))
	}
	return typedFrom[IndiceInflacion](e.Match())
}
...
func (e *IndiceInflacionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IndiceInflacionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *IndiceInflacionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IndiceInflacionListMatch and returns []IndiceInflacion. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *IndiceInflacionEntity) ListTyped(reqmatch IndiceInflacionListMatch, ctrl map[string]any) ([]IndiceInflacion, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[IndiceInflacion](res), nil
}



func (e *IndiceInflacionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IndiceInflacionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IndiceInflacionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IndiceInflacionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
