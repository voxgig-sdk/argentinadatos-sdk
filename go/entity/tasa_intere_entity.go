...
func NewTasaIntereEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *TasaIntereEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TasaIntereEntity) GetName() string { return e.name }
...
func (e *TasaIntereEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TasaIntereEntity) Deleted() bool {
	return e.deleted
}


func (e *TasaIntereEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTasaIntereEntity(e.client, opts)
}

func (e *TasaIntereEntity) Data(args ...any) any {
...
func (e *TasaIntereEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TasaIntere; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TasaIntereEntity) DataTyped(data ...TasaIntere) TasaIntere {
	if len(data) > 0 {
		return typedFrom[TasaIntere](e.Data(asMap(data[0])))
	}
	return typedFrom[TasaIntere](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TasaIntere (all fields
// optional at the wire level).
func (e *TasaIntereEntity) MatchTyped(match ...TasaIntere) TasaIntere {
	if len(match) > 0 {
		return typedFrom[TasaIntere](e.Match(asMap(match[0])))
	}
	return typedFrom[TasaIntere](e.Match())
}
...
func (e *TasaIntereEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TasaIntereEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TasaIntereEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TasaIntereListMatch and returns []TasaIntere. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TasaIntereEntity) ListTyped(reqmatch TasaIntereListMatch, ctrl map[string]any) ([]TasaIntere, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TasaIntere](res), nil
}



func (e *TasaIntereEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TasaIntereEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TasaIntereEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TasaIntereEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
