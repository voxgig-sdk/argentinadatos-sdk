...
func NewFinanzaEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *FinanzaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FinanzaEntity) GetName() string { return e.name }
...
func (e *FinanzaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FinanzaEntity) Deleted() bool {
	return e.deleted
}


func (e *FinanzaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFinanzaEntity(e.client, opts)
}

func (e *FinanzaEntity) Data(args ...any) any {
...
func (e *FinanzaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Finanza; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FinanzaEntity) DataTyped(data ...Finanza) Finanza {
	if len(data) > 0 {
		return typedFrom[Finanza](e.Data(asMap(data[0])))
	}
	return typedFrom[Finanza](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Finanza (all fields
// optional at the wire level).
func (e *FinanzaEntity) MatchTyped(match ...Finanza) Finanza {
	if len(match) > 0 {
		return typedFrom[Finanza](e.Match(asMap(match[0])))
	}
	return typedFrom[Finanza](e.Match())
}
...
func (e *FinanzaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FinanzaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FinanzaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FinanzaListMatch and returns []Finanza. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FinanzaEntity) ListTyped(reqmatch FinanzaListMatch, ctrl map[string]any) ([]Finanza, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Finanza](res), nil
}



func (e *FinanzaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FinanzaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FinanzaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FinanzaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
