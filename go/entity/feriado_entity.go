...
func NewFeriadoEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *FeriadoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FeriadoEntity) GetName() string { return e.name }
...
func (e *FeriadoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FeriadoEntity) Deleted() bool {
	return e.deleted
}


func (e *FeriadoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFeriadoEntity(e.client, opts)
}

func (e *FeriadoEntity) Data(args ...any) any {
...
func (e *FeriadoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Feriado; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FeriadoEntity) DataTyped(data ...Feriado) Feriado {
	if len(data) > 0 {
		return typedFrom[Feriado](e.Data(asMap(data[0])))
	}
	return typedFrom[Feriado](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Feriado (all fields
// optional at the wire level).
func (e *FeriadoEntity) MatchTyped(match ...Feriado) Feriado {
	if len(match) > 0 {
		return typedFrom[Feriado](e.Match(asMap(match[0])))
	}
	return typedFrom[Feriado](e.Match())
}
...
func (e *FeriadoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FeriadoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FeriadoLoadMatch and returns an Feriado. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FeriadoEntity) LoadTyped(reqmatch FeriadoLoadMatch, ctrl map[string]any) (Feriado, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Feriado{}, err
	}
	return typedFrom[Feriado](res), nil
}



func (e *FeriadoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FeriadoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FeriadoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FeriadoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FeriadoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
