...
type FondoComunInversionEntity struct {
	name    string
...
func NewFondoComunInversionEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *FondoComunInversionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FondoComunInversionEntity) GetName() string { return e.name }
...
func (e *FondoComunInversionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FondoComunInversionEntity) Deleted() bool {
	return e.deleted
}


func (e *FondoComunInversionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFondoComunInversionEntity(e.client, opts)
}

func (e *FondoComunInversionEntity) Data(args ...any) any {
...
func (e *FondoComunInversionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FondoComunInversion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FondoComunInversionEntity) DataTyped(data ...FondoComunInversion) FondoComunInversion {
	if len(data) > 0 {
		return typedFrom[FondoComunInversion](e.Data(asMap(data[0])))
	}
	return typedFrom[FondoComunInversion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FondoComunInversion (all fields
// optional at the wire level).
func (e *FondoComunInversionEntity) MatchTyped(match ...FondoComunInversion) FondoComunInversion {
	if len(match) > 0 {
		return typedFrom[FondoComunInversion](e.Match(asMap(match[0])))
	}
	return typedFrom[FondoComunInversion](e.Match())
}
...
func (e *FondoComunInversionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FondoComunInversionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FondoComunInversionLoadMatch and returns an FondoComunInversion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FondoComunInversionEntity) LoadTyped(reqmatch FondoComunInversionLoadMatch, ctrl map[string]any) (FondoComunInversion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FondoComunInversion{}, err
	}
	return typedFrom[FondoComunInversion](res), nil
}



func (e *FondoComunInversionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FondoComunInversionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FondoComunInversionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FondoComunInversionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FondoComunInversionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
