...
type HipotecarioUvaTnaEntity struct {
	name    string
...
func NewHipotecarioUvaTnaEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *HipotecarioUvaTnaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HipotecarioUvaTnaEntity) GetName() string { return e.name }
...
func (e *HipotecarioUvaTnaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HipotecarioUvaTnaEntity) Deleted() bool {
	return e.deleted
}


func (e *HipotecarioUvaTnaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHipotecarioUvaTnaEntity(e.client, opts)
}

func (e *HipotecarioUvaTnaEntity) Data(args ...any) any {
...
func (e *HipotecarioUvaTnaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *HipotecarioUvaTnaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HipotecarioUvaTnaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *HipotecarioUvaTnaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HipotecarioUvaTnaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HipotecarioUvaTnaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HipotecarioUvaTnaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
