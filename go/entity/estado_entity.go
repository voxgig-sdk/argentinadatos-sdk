...
func NewEstadoEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *EstadoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EstadoEntity) GetName() string { return e.name }
...
func (e *EstadoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EstadoEntity) Deleted() bool {
	return e.deleted
}


func (e *EstadoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEstadoEntity(e.client, opts)
}

func (e *EstadoEntity) Data(args ...any) any {
...
func (e *EstadoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Estado; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EstadoEntity) DataTyped(data ...Estado) Estado {
	if len(data) > 0 {
		return typedFrom[Estado](e.Data(asMap(data[0])))
	}
	return typedFrom[Estado](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Estado (all fields
// optional at the wire level).
func (e *EstadoEntity) MatchTyped(match ...Estado) Estado {
	if len(match) > 0 {
		return typedFrom[Estado](e.Match(asMap(match[0])))
	}
	return typedFrom[Estado](e.Match())
}
...
func (e *EstadoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EstadoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EstadoLoadMatch and returns an Estado. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EstadoEntity) LoadTyped(reqmatch EstadoLoadMatch, ctrl map[string]any) (Estado, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Estado{}, err
	}
	return typedFrom[Estado](res), nil
}



func (e *EstadoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EstadoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EstadoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EstadoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EstadoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
