...
type RemExpectativaEntity struct {
	name    string
...
func NewRemExpectativaEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *RemExpectativaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RemExpectativaEntity) GetName() string { return e.name }
...
func (e *RemExpectativaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RemExpectativaEntity) Deleted() bool {
	return e.deleted
}


func (e *RemExpectativaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRemExpectativaEntity(e.client, opts)
}

func (e *RemExpectativaEntity) Data(args ...any) any {
...
func (e *RemExpectativaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *RemExpectativaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RemExpectativaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *RemExpectativaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RemExpectativaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RemExpectativaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RemExpectativaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
