...
func NewActaEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *ActaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActaEntity) GetName() string { return e.name }
...
func (e *ActaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActaEntity) Deleted() bool {
	return e.deleted
}


func (e *ActaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActaEntity(e.client, opts)
}

func (e *ActaEntity) Data(args ...any) any {
...
func (e *ActaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Acta; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActaEntity) DataTyped(data ...Acta) Acta {
	if len(data) > 0 {
		return typedFrom[Acta](e.Data(asMap(data[0])))
	}
	return typedFrom[Acta](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Acta (all fields
// optional at the wire level).
func (e *ActaEntity) MatchTyped(match ...Acta) Acta {
	if len(match) > 0 {
		return typedFrom[Acta](e.Match(asMap(match[0])))
	}
	return typedFrom[Acta](e.Match())
}
...
func (e *ActaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActaLoadMatch and returns an Acta. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ActaEntity) LoadTyped(reqmatch ActaLoadMatch, ctrl map[string]any) (Acta, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Acta{}, err
	}
	return typedFrom[Acta](res), nil
}




func (e *ActaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ActaListMatch and returns []Acta. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ActaEntity) ListTyped(reqmatch ActaListMatch, ctrl map[string]any) ([]Acta, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Acta](res), nil
}



func (e *ActaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ActaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ActaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
