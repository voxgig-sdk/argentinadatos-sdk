...
func NewPresidenteEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *PresidenteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PresidenteEntity) GetName() string { return e.name }
...
func (e *PresidenteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PresidenteEntity) Deleted() bool {
	return e.deleted
}


func (e *PresidenteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPresidenteEntity(e.client, opts)
}

func (e *PresidenteEntity) Data(args ...any) any {
...
func (e *PresidenteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Presidente; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PresidenteEntity) DataTyped(data ...Presidente) Presidente {
	if len(data) > 0 {
		return typedFrom[Presidente](e.Data(asMap(data[0])))
	}
	return typedFrom[Presidente](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Presidente (all fields
// optional at the wire level).
func (e *PresidenteEntity) MatchTyped(match ...Presidente) Presidente {
	if len(match) > 0 {
		return typedFrom[Presidente](e.Match(asMap(match[0])))
	}
	return typedFrom[Presidente](e.Match())
}
...
func (e *PresidenteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PresidenteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PresidenteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PresidenteListMatch and returns []Presidente. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PresidenteEntity) ListTyped(reqmatch PresidenteListMatch, ctrl map[string]any) ([]Presidente, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Presidente](res), nil
}



func (e *PresidenteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PresidenteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PresidenteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PresidenteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
