...
func NewLetraEntity(client *core.ArgentinadatosSDK, entopts map[string]any) *LetraEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LetraEntity) GetName() string { return e.name }
...
func (e *LetraEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LetraEntity) Deleted() bool {
	return e.deleted
}


func (e *LetraEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLetraEntity(e.client, opts)
}

func (e *LetraEntity) Data(args ...any) any {
...
func (e *LetraEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Letra; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LetraEntity) DataTyped(data ...Letra) Letra {
	if len(data) > 0 {
		return typedFrom[Letra](e.Data(asMap(data[0])))
	}
	return typedFrom[Letra](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Letra (all fields
// optional at the wire level).
func (e *LetraEntity) MatchTyped(match ...Letra) Letra {
	if len(match) > 0 {
		return typedFrom[Letra](e.Match(asMap(match[0])))
	}
	return typedFrom[Letra](e.Match())
}
...
func (e *LetraEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LetraEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LetraEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LetraListMatch and returns []Letra. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LetraEntity) ListTyped(reqmatch LetraListMatch, ctrl map[string]any) ([]Letra, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Letra](res), nil
}



func (e *LetraEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LetraEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LetraEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LetraEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
