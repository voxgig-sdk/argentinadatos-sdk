...
func TestProveedorPlazoFijoPrecancelableEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		...
		var seen []any
		for item := range base.ProveedorPlazoFijoPrecancelable(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.ProveedorPlazoFijoPrecancelable(nil).Stream("list", nil, nil) {
