...
const testSeed = `map[string]any{"entity": map[string]any{"acta": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bonos_cer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cotizacion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "criptopeso": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cuenta_remunerada_usd": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "diputado": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "entidad_rendimiento": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "estado": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "evento_presidencial": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "feriado": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "finanza": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fondo_comun_inversion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fondo_comun_inversion_otro": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fondo_comun_inversion_variable": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "hipotecario_uva_tna": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "indice_inflacion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "indice_uva": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "letra": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "presidente": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "proveedor_plazo_fijo_precancelable": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "proveedor_plazo_fijo_uva_pago_periodico": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rem": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rem_expectativa": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rendimiento": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "riesgo_pai": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "senador": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tasa_intere": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tasa_plazo_fijo": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
