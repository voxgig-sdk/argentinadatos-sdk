...
## Install
```bash
go get github.com/voxgig-sdk/argentinadatos-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/argentinadatos-sdk=../path/to/github.com/voxgig-sdk/argentinadatos-sdk
```
...
```
github.com/voxgig-sdk/argentinadatos-sdk/
...
The root package (`github.com/voxgig-sdk/argentinadatos-sdk`) re-exports everything needed
