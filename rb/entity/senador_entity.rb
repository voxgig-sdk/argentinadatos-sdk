...
class SenadorEntity
  ...
  def make
    opts = @_entopts.dup
    SenadorEntity.new(@_client, opts)
  end
  ...
  # @return [Senador, Hash] the current Senador data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Senador fields)
  def match_get
  ...
  #
  # @param reqmatch [SenadorListMatch, Hash, nil] match filter (any subset of
  #   Senador fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Senador>, Array] the matching Senador items; raises ArgentinadatosError on failure
