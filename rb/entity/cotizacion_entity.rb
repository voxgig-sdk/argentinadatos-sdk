...
class CotizacionEntity
  ...
  def make
    opts = @_entopts.dup
    CotizacionEntity.new(@_client, opts)
  end
  ...
  # @return [Cotizacion, Hash] the current Cotizacion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cotizacion fields)
  def match_get
  ...
  #
  # @param reqmatch [CotizacionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Cotizacion.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cotizacion, Hash] the loaded Cotizacion; raises ArgentinadatosError on failure
  ...
  #
  # @param reqmatch [CotizacionListMatch, Hash, nil] match filter (any subset of
  #   Cotizacion fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Cotizacion>, Array] the matching Cotizacion items; raises ArgentinadatosError on failure
