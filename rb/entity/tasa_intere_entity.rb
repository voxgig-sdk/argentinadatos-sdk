...
class TasaIntereEntity
  ...
  def make
    opts = @_entopts.dup
    TasaIntereEntity.new(@_client, opts)
  end
  ...
  # @return [TasaIntere, Hash] the current TasaIntere data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TasaIntere fields)
  def match_get
  ...
  #
  # @param reqmatch [TasaIntereListMatch, Hash, nil] match filter (any subset of
  #   TasaIntere fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<TasaIntere>, Array] the matching TasaIntere items; raises ArgentinadatosError on failure
