...
class HipotecarioUvaTnaEntity
  ...
  def make
    opts = @_entopts.dup
    HipotecarioUvaTnaEntity.new(@_client, opts)
  end
  ...
  # @return [HipotecarioUvaTna, Hash] the current HipotecarioUvaTna data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of HipotecarioUvaTna fields)
  def match_get
  ...
  #
  # @param reqmatch [HipotecarioUvaTnaListMatch, Hash, nil] match filter (any subset of
  #   HipotecarioUvaTna fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<HipotecarioUvaTna>, Array] the matching HipotecarioUvaTna items; raises ArgentinadatosError on failure
