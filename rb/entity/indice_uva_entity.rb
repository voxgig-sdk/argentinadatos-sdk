...
class IndiceUvaEntity
  ...
  def make
    opts = @_entopts.dup
    IndiceUvaEntity.new(@_client, opts)
  end
  ...
  # @return [IndiceUva, Hash] the current IndiceUva data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IndiceUva fields)
  def match_get
  ...
  #
  # @param reqmatch [IndiceUvaListMatch, Hash, nil] match filter (any subset of
  #   IndiceUva fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<IndiceUva>, Array] the matching IndiceUva items; raises ArgentinadatosError on failure
