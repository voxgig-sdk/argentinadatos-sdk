...
class EntidadRendimientoEntity
  ...
  def make
    opts = @_entopts.dup
    EntidadRendimientoEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [EntidadRendimientoListMatch, Hash, nil] match filter (any subset of
  #   EntidadRendimiento fields); defaults to nil, treated as an empty match that lists all.
