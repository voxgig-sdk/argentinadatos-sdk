...
class RemExpectativaEntity
  ...
  def make
    opts = @_entopts.dup
    RemExpectativaEntity.new(@_client, opts)
  end
  ...
  # @return [RemExpectativa, Hash] the current RemExpectativa data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RemExpectativa fields)
  def match_get
  ...
  #
  # @param reqmatch [RemExpectativaListMatch, Hash, nil] match filter (any subset of
  #   RemExpectativa fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RemExpectativa>, Array] the matching RemExpectativa items; raises ArgentinadatosError on failure
