...
class EventoPresidencialEntity
  ...
  def make
    opts = @_entopts.dup
    EventoPresidencialEntity.new(@_client, opts)
  end
  ...
  # @return [EventoPresidencial, Hash] the current EventoPresidencial data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EventoPresidencial fields)
  def match_get
  ...
  #
  # @param reqmatch [EventoPresidencialListMatch, Hash, nil] match filter (any subset of
  #   EventoPresidencial fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EventoPresidencial>, Array] the matching EventoPresidencial items; raises ArgentinadatosError on failure
