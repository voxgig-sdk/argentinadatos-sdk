...
class ProveedorPlazoFijoPrecancelableEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "proveedor_plazo_fijo_precancelable"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ProveedorPlazoFijoPrecancelableEntity.new(@_client, opts)
  end
  ...
  # @return [ProveedorPlazoFijoPrecancelable, Hash] the current ProveedorPlazoFijoPrecancelable data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProveedorPlazoFijoPrecancelable fields)
  def match_get
  ...
  #
  # @param reqmatch [ProveedorPlazoFijoPrecancelableListMatch, Hash, nil] match filter (any subset of
  #   ProveedorPlazoFijoPrecancelable fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ProveedorPlazoFijoPrecancelable>, Array] the matching ProveedorPlazoFijoPrecancelable items; raises ArgentinadatosError on failure
