...
class FondoComunInversionEntity
  ...
  def make
    opts = @_entopts.dup
    FondoComunInversionEntity.new(@_client, opts)
  end
  ...
  # @return [FondoComunInversion, Hash] the current FondoComunInversion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FondoComunInversion fields)
  def match_get
