...
class TasaPlazoFijoEntity
  ...
  def make
    opts = @_entopts.dup
    TasaPlazoFijoEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [TasaPlazoFijoListMatch, Hash, nil] match filter (any subset of
  #   TasaPlazoFijo fields); defaults to nil, treated as an empty match that lists all.
