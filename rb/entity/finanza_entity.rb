...
class FinanzaEntity
  ...
  def make
    opts = @_entopts.dup
    FinanzaEntity.new(@_client, opts)
  end
  ...
  # @return [Finanza, Hash] the current Finanza data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Finanza fields)
  def match_get
  ...
  #
  # @param reqmatch [FinanzaListMatch, Hash, nil] match filter (any subset of
  #   Finanza fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Finanza>, Array] the matching Finanza items; raises ArgentinadatosError on failure
