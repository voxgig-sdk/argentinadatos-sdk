...
class CuentaRemuneradaUsdEntity
  ...
  def make
    opts = @_entopts.dup
    CuentaRemuneradaUsdEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CuentaRemuneradaUsdListMatch, Hash, nil] match filter (any subset of
  #   CuentaRemuneradaUsd fields); defaults to nil, treated as an empty match that lists all.
