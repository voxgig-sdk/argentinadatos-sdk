...
class CriptopesoEntity
  ...
  def make
    opts = @_entopts.dup
    CriptopesoEntity.new(@_client, opts)
  end
  ...
  # @return [Criptopeso, Hash] the current Criptopeso data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Criptopeso fields)
  def match_get
  ...
  #
  # @param reqmatch [CriptopesoListMatch, Hash, nil] match filter (any subset of
  #   Criptopeso fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Criptopeso>, Array] the matching Criptopeso items; raises ArgentinadatosError on failure
