...
class FeriadoEntity
  ...
  def make
    opts = @_entopts.dup
    FeriadoEntity.new(@_client, opts)
  end
  ...
  # @return [Feriado, Hash] the current Feriado data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Feriado fields)
  def match_get
  ...
  # @return [Feriado, Hash] the loaded Feriado; raises ArgentinadatosError on failure
