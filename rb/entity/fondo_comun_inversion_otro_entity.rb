...
class FondoComunInversionOtroEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "fondo_comun_inversion_otro"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    FondoComunInversionOtroEntity.new(@_client, opts)
  end
  ...
  # @return [FondoComunInversionOtro, Hash] the current FondoComunInversionOtro data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FondoComunInversionOtro fields)
  def match_get
  ...
  #
  # @param reqmatch [FondoComunInversionOtroLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.FondoComunInversionOtro.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [FondoComunInversionOtro, Hash] the loaded FondoComunInversionOtro; raises ArgentinadatosError on failure
