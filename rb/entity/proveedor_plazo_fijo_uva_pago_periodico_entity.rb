...
class ProveedorPlazoFijoUvaPagoPeriodicoEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "proveedor_plazo_fijo_uva_pago_periodico"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ProveedorPlazoFijoUvaPagoPeriodicoEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ProveedorPlazoFijoUvaPagoPeriodicoListMatch, Hash, nil] match filter (any subset of
  #   ProveedorPlazoFijoUvaPagoPeriodico fields); defaults to nil, treated as an empty match that lists all.
