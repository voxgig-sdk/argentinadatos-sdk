...
class IndiceInflacionEntity
  ...
  def make
    opts = @_entopts.dup
    IndiceInflacionEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [IndiceInflacionListMatch, Hash, nil] match filter (any subset of
  #   IndiceInflacion fields); defaults to nil, treated as an empty match that lists all.
