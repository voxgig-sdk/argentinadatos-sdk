...
class BonosCerEntity
  ...
  def make
    opts = @_entopts.dup
    BonosCerEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [BonosCerListMatch, Hash, nil] match filter (any subset of
  #   BonosCer fields); defaults to nil, treated as an empty match that lists all.
