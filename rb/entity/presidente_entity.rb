...
class PresidenteEntity
  ...
  def make
    opts = @_entopts.dup
    PresidenteEntity.new(@_client, opts)
  end
  ...
  # @return [Presidente, Hash] the current Presidente data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Presidente fields)
  def match_get
  ...
  #
  # @param reqmatch [PresidenteListMatch, Hash, nil] match filter (any subset of
  #   Presidente fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Presidente>, Array] the matching Presidente items; raises ArgentinadatosError on failure
