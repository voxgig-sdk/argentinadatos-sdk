...
class DiputadoEntity
  ...
  def make
    opts = @_entopts.dup
    DiputadoEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [DiputadoListMatch, Hash, nil] match filter (any subset of
  #   Diputado fields); defaults to nil, treated as an empty match that lists all.
