...
class LetraEntity
  ...
  # @return [Letra, Hash] the current Letra data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Letra fields)
  def match_get
  ...
  #
  # @param reqmatch [LetraListMatch, Hash, nil] match filter (any subset of
  #   Letra fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Letra>, Array] the matching Letra items; raises ArgentinadatosError on failure
