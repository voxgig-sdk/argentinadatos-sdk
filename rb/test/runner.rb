...
module ArgentinadatosTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("ARGENTINADATOS_TEST_LIVE")
    override = getenv("ARGENTINADATOS_TEST_OVERRIDE")
    ...
    explain = getenv("ARGENTINADATOS_TEST_EXPLAIN")
    m["ARGENTINADATOS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ArgentinadatosTestRunner
Helpers = ArgentinadatosHelpers
Vs = VoxgigStruct
