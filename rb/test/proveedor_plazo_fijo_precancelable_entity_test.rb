...
class ProveedorPlazoFijoPrecancelableEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    proveedor_plazo_fijo_precancelable_ref01_list_result, err = proveedor_plazo_fijo_precancelable_ref01_ent.list(proveedor_plazo_fijo_precancelable_ref01_match, nil)
    assert_nil err
