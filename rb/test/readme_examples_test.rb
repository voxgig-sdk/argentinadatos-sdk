...
#      offline in seeded test mode (ArgentinadatosSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Argentinadatos_sdk.rb")
  SDK_CLASS = "ArgentinadatosSDK"
