...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/argentinadatos` | `npm install @voxgig-sdk/argentinadatos` |
| Python | `voxgig-sdk-argentinadatos` | `pip install voxgig-sdk-argentinadatos` |
| PHP | `voxgig-sdk/argentinadatos` | `composer require voxgig-sdk/argentinadatos` |
| Golang | `github.com/voxgig-sdk/argentinadatos-sdk/go` | `go get github.com/voxgig-sdk/argentinadatos-sdk/go` |
| Ruby | `voxgig-sdk-argentinadatos` | `gem install voxgig-sdk-argentinadatos` |
| Lua | `voxgig-sdk-argentinadatos` | `luarocks install voxgig-sdk-argentinadatos` |
