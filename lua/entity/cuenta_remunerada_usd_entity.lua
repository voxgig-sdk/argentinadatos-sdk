-- Argentinadatos SDK CuentaRemuneradaUsd entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CuentaRemuneradaUsdEntity = {}
CuentaRemuneradaUsdEntity.__index = CuentaRemuneradaUsdEntity


function CuentaRemuneradaUsdEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CuentaRemuneradaUsdEntity)
  self._name = "cuenta_remunerada_usd"
  self._client = client
...
function CuentaRemuneradaUsdEntity:get_name()
  return self._name
end


function CuentaRemuneradaUsdEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CuentaRemuneradaUsdEntity.new(self._client, opts)
end
...
function CuentaRemuneradaUsdEntity:mark_deleted()
  self._deleted = true
end


function CuentaRemuneradaUsdEntity:deleted()
  return true == self._deleted
end


function CuentaRemuneradaUsdEntity:data_set(args)
  if args ~= nil then
...
function CuentaRemuneradaUsdEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CuentaRemuneradaUsdEntity:match_set(args)
  if args ~= nil then
...
function CuentaRemuneradaUsdEntity:match_get()
...
function CuentaRemuneradaUsdEntity:stream(action, args, callopts)
...
---@param reqmatch CuentaRemuneradaUsdListMatch
---@param ctrl? table
---@return CuentaRemuneradaUsd[]
---@return string? err
function CuentaRemuneradaUsdEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CuentaRemuneradaUsdEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CuentaRemuneradaUsdEntity
