...
local ProveedorPlazoFijoPrecancelableEntity = {}
ProveedorPlazoFijoPrecancelableEntity.__index = ProveedorPlazoFijoPrecancelableEntity


function ProveedorPlazoFijoPrecancelableEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProveedorPlazoFijoPrecancelableEntity)
  self._name = "proveedor_plazo_fijo_precancelable"
  self._client = client
...
function ProveedorPlazoFijoPrecancelableEntity:get_name()
  return self._name
end


function ProveedorPlazoFijoPrecancelableEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProveedorPlazoFijoPrecancelableEntity.new(self._client, opts)
end
...
function ProveedorPlazoFijoPrecancelableEntity:mark_deleted()
  self._deleted = true
end


function ProveedorPlazoFijoPrecancelableEntity:deleted()
  return true == self._deleted
end


function ProveedorPlazoFijoPrecancelableEntity:data_set(args)
  if args ~= nil then
...
function ProveedorPlazoFijoPrecancelableEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProveedorPlazoFijoPrecancelableEntity:match_set(args)
  if args ~= nil then
...
function ProveedorPlazoFijoPrecancelableEntity:match_get()
...
function ProveedorPlazoFijoPrecancelableEntity:stream(action, args, callopts)
...
function ProveedorPlazoFijoPrecancelableEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ProveedorPlazoFijoPrecancelableEntity
