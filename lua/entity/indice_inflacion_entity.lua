...
local IndiceInflacionEntity = {}
IndiceInflacionEntity.__index = IndiceInflacionEntity


function IndiceInflacionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IndiceInflacionEntity)
  self._name = "indice_inflacion"
  self._client = client
...
function IndiceInflacionEntity:get_name()
  return self._name
end


function IndiceInflacionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IndiceInflacionEntity.new(self._client, opts)
end
...
function IndiceInflacionEntity:mark_deleted()
  self._deleted = true
end


function IndiceInflacionEntity:deleted()
  return true == self._deleted
end


function IndiceInflacionEntity:data_set(args)
  if args ~= nil then
...
function IndiceInflacionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IndiceInflacionEntity:match_set(args)
  if args ~= nil then
...
function IndiceInflacionEntity:match_get()
...
function IndiceInflacionEntity:stream(action, args, callopts)
...
function IndiceInflacionEntity:_run_op(ctx, post_done)
  local utility = self._utility
