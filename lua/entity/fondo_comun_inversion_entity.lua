...
local FondoComunInversionEntity = {}
FondoComunInversionEntity.__index = FondoComunInversionEntity


function FondoComunInversionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FondoComunInversionEntity)
  self._name = "fondo_comun_inversion"
  self._client = client
...
function FondoComunInversionEntity:get_name()
  return self._name
end


function FondoComunInversionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FondoComunInversionEntity.new(self._client, opts)
end
...
function FondoComunInversionEntity:mark_deleted()
  self._deleted = true
end


function FondoComunInversionEntity:deleted()
  return true == self._deleted
end


function FondoComunInversionEntity:data_set(args)
  if args ~= nil then
...
function FondoComunInversionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FondoComunInversionEntity:match_set(args)
  if args ~= nil then
...
function FondoComunInversionEntity:match_get()
...
function FondoComunInversionEntity:stream(action, args, callopts)
...
---@param reqmatch FondoComunInversionLoadMatch
---@param ctrl? table
---@return FondoComunInversion
---@return string? err
function FondoComunInversionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FondoComunInversionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FondoComunInversionEntity
