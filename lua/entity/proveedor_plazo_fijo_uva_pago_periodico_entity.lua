-- Argentinadatos SDK ProveedorPlazoFijoUvaPagoPeriodico entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ProveedorPlazoFijoUvaPagoPeriodicoEntity = {}
ProveedorPlazoFijoUvaPagoPeriodicoEntity.__index = ProveedorPlazoFijoUvaPagoPeriodicoEntity


function ProveedorPlazoFijoUvaPagoPeriodicoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProveedorPlazoFijoUvaPagoPeriodicoEntity)
  self._name = "proveedor_plazo_fijo_uva_pago_periodico"
  self._client = client
...
function ProveedorPlazoFijoUvaPagoPeriodicoEntity:get_name()
  return self._name
end


function ProveedorPlazoFijoUvaPagoPeriodicoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProveedorPlazoFijoUvaPagoPeriodicoEntity.new(self._client, opts)
end
...
function ProveedorPlazoFijoUvaPagoPeriodicoEntity:mark_deleted()
  self._deleted = true
end


function ProveedorPlazoFijoUvaPagoPeriodicoEntity:deleted()
  return true == self._deleted
end


function ProveedorPlazoFijoUvaPagoPeriodicoEntity:data_set(args)
  if args ~= nil then
...
function ProveedorPlazoFijoUvaPagoPeriodicoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProveedorPlazoFijoUvaPagoPeriodicoEntity:match_set(args)
  if args ~= nil then
...
function ProveedorPlazoFijoUvaPagoPeriodicoEntity:match_get()
...
function ProveedorPlazoFijoUvaPagoPeriodicoEntity:stream(action, args, callopts)
...
function ProveedorPlazoFijoUvaPagoPeriodicoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ProveedorPlazoFijoUvaPagoPeriodicoEntity
