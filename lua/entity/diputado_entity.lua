...
local DiputadoEntity = {}
DiputadoEntity.__index = DiputadoEntity


function DiputadoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DiputadoEntity)
  self._name = "diputado"
  self._client = client
...
function DiputadoEntity:get_name()
  return self._name
end


function DiputadoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DiputadoEntity.new(self._client, opts)
end
...
function DiputadoEntity:mark_deleted()
  self._deleted = true
end


function DiputadoEntity:deleted()
  return true == self._deleted
end


function DiputadoEntity:data_set(args)
  if args ~= nil then
...
function DiputadoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DiputadoEntity:match_set(args)
  if args ~= nil then
...
function DiputadoEntity:match_get()
...
function DiputadoEntity:stream(action, args, callopts)
...
---@param reqmatch DiputadoListMatch
---@param ctrl? table
---@return Diputado[]
---@return string? err
function DiputadoEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function DiputadoEntity:_run_op(ctx, post_done)
  local utility = self._utility
