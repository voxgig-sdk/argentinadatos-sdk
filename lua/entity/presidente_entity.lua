...
local PresidenteEntity = {}
PresidenteEntity.__index = PresidenteEntity


function PresidenteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PresidenteEntity)
  self._name = "presidente"
  self._client = client
...
function PresidenteEntity:get_name()
  return self._name
end


function PresidenteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PresidenteEntity.new(self._client, opts)
end
...
function PresidenteEntity:mark_deleted()
  self._deleted = true
end


function PresidenteEntity:deleted()
  return true == self._deleted
end


function PresidenteEntity:data_set(args)
  if args ~= nil then
...
function PresidenteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PresidenteEntity:match_set(args)
  if args ~= nil then
...
function PresidenteEntity:match_get()
...
function PresidenteEntity:stream(action, args, callopts)
...
function PresidenteEntity:_run_op(ctx, post_done)
  local utility = self._utility
