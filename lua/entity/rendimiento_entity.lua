...
local RendimientoEntity = {}
RendimientoEntity.__index = RendimientoEntity


function RendimientoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RendimientoEntity)
  self._name = "rendimiento"
  self._client = client
...
function RendimientoEntity:get_name()
  return self._name
end


function RendimientoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RendimientoEntity.new(self._client, opts)
end
...
function RendimientoEntity:mark_deleted()
  self._deleted = true
end


function RendimientoEntity:deleted()
  return true == self._deleted
end


function RendimientoEntity:data_set(args)
  if args ~= nil then
...
function RendimientoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RendimientoEntity:match_set(args)
  if args ~= nil then
...
function RendimientoEntity:match_get()
...
function RendimientoEntity:stream(action, args, callopts)
...
function RendimientoEntity:_run_op(ctx, post_done)
  local utility = self._utility
