...
local FondoComunInversionOtroEntity = {}
FondoComunInversionOtroEntity.__index = FondoComunInversionOtroEntity


function FondoComunInversionOtroEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FondoComunInversionOtroEntity)
  self._name = "fondo_comun_inversion_otro"
  self._client = client
...
function FondoComunInversionOtroEntity:get_name()
  return self._name
end


function FondoComunInversionOtroEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FondoComunInversionOtroEntity.new(self._client, opts)
end
...
function FondoComunInversionOtroEntity:mark_deleted()
  self._deleted = true
end


function FondoComunInversionOtroEntity:deleted()
  return true == self._deleted
end


function FondoComunInversionOtroEntity:data_set(args)
  if args ~= nil then
...
function FondoComunInversionOtroEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FondoComunInversionOtroEntity:match_set(args)
  if args ~= nil then
...
function FondoComunInversionOtroEntity:match_get()
...
function FondoComunInversionOtroEntity:stream(action, args, callopts)
...
---@param reqmatch FondoComunInversionOtroLoadMatch
---@param ctrl? table
---@return FondoComunInversionOtro
---@return string? err
function FondoComunInversionOtroEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FondoComunInversionOtroEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FondoComunInversionOtroEntity
