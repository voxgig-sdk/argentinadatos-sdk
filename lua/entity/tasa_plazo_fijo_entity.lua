...
local TasaPlazoFijoEntity = {}
TasaPlazoFijoEntity.__index = TasaPlazoFijoEntity


function TasaPlazoFijoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TasaPlazoFijoEntity)
  self._name = "tasa_plazo_fijo"
  self._client = client
...
function TasaPlazoFijoEntity:get_name()
  return self._name
end


function TasaPlazoFijoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TasaPlazoFijoEntity.new(self._client, opts)
end
...
function TasaPlazoFijoEntity:mark_deleted()
  self._deleted = true
end


function TasaPlazoFijoEntity:deleted()
  return true == self._deleted
end


function TasaPlazoFijoEntity:data_set(args)
  if args ~= nil then
...
function TasaPlazoFijoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TasaPlazoFijoEntity:match_set(args)
  if args ~= nil then
...
function TasaPlazoFijoEntity:match_get()
...
function TasaPlazoFijoEntity:stream(action, args, callopts)
...
function TasaPlazoFijoEntity:_run_op(ctx, post_done)
  local utility = self._utility
