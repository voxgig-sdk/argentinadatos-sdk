...
local CriptopesoEntity = {}
CriptopesoEntity.__index = CriptopesoEntity


function CriptopesoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CriptopesoEntity)
  self._name = "criptopeso"
  self._client = client
...
function CriptopesoEntity:get_name()
  return self._name
end


function CriptopesoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CriptopesoEntity.new(self._client, opts)
end
...
function CriptopesoEntity:mark_deleted()
  self._deleted = true
end


function CriptopesoEntity:deleted()
  return true == self._deleted
end


function CriptopesoEntity:data_set(args)
  if args ~= nil then
...
function CriptopesoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CriptopesoEntity:match_set(args)
  if args ~= nil then
...
function CriptopesoEntity:match_get()
...
function CriptopesoEntity:stream(action, args, callopts)
...
function CriptopesoEntity:_run_op(ctx, post_done)
  local utility = self._utility
