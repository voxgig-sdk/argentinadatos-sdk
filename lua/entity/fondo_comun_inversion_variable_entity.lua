-- Argentinadatos SDK FondoComunInversionVariable entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local FondoComunInversionVariableEntity = {}
FondoComunInversionVariableEntity.__index = FondoComunInversionVariableEntity


function FondoComunInversionVariableEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FondoComunInversionVariableEntity)
  self._name = "fondo_comun_inversion_variable"
  self._client = client
...
function FondoComunInversionVariableEntity:get_name()
  return self._name
end


function FondoComunInversionVariableEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FondoComunInversionVariableEntity.new(self._client, opts)
end
...
function FondoComunInversionVariableEntity:mark_deleted()
  self._deleted = true
end


function FondoComunInversionVariableEntity:deleted()
  return true == self._deleted
end


function FondoComunInversionVariableEntity:data_set(args)
  if args ~= nil then
...
function FondoComunInversionVariableEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FondoComunInversionVariableEntity:match_set(args)
  if args ~= nil then
...
function FondoComunInversionVariableEntity:match_get()
...
function FondoComunInversionVariableEntity:stream(action, args, callopts)
...
---@param reqmatch FondoComunInversionVariableLoadMatch
---@param ctrl? table
---@return FondoComunInversionVariable
---@return string? err
function FondoComunInversionVariableEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FondoComunInversionVariableEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FondoComunInversionVariableEntity
