...
local EntidadRendimientoEntity = {}
EntidadRendimientoEntity.__index = EntidadRendimientoEntity


function EntidadRendimientoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EntidadRendimientoEntity)
  self._name = "entidad_rendimiento"
  self._client = client
...
function EntidadRendimientoEntity:get_name()
  return self._name
end


function EntidadRendimientoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EntidadRendimientoEntity.new(self._client, opts)
end
...
function EntidadRendimientoEntity:mark_deleted()
  self._deleted = true
end


function EntidadRendimientoEntity:deleted()
  return true == self._deleted
end


function EntidadRendimientoEntity:data_set(args)
  if args ~= nil then
...
function EntidadRendimientoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EntidadRendimientoEntity:match_set(args)
  if args ~= nil then
...
function EntidadRendimientoEntity:match_get()
...
function EntidadRendimientoEntity:stream(action, args, callopts)
...
function EntidadRendimientoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EntidadRendimientoEntity
