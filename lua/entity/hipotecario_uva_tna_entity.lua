-- Argentinadatos SDK HipotecarioUvaTna entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local HipotecarioUvaTnaEntity = {}
HipotecarioUvaTnaEntity.__index = HipotecarioUvaTnaEntity


function HipotecarioUvaTnaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HipotecarioUvaTnaEntity)
  self._name = "hipotecario_uva_tna"
  self._client = client
...
function HipotecarioUvaTnaEntity:get_name()
  return self._name
end


function HipotecarioUvaTnaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HipotecarioUvaTnaEntity.new(self._client, opts)
end
...
function HipotecarioUvaTnaEntity:mark_deleted()
  self._deleted = true
end


function HipotecarioUvaTnaEntity:deleted()
  return true == self._deleted
end


function HipotecarioUvaTnaEntity:data_set(args)
  if args ~= nil then
...
function HipotecarioUvaTnaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HipotecarioUvaTnaEntity:match_set(args)
  if args ~= nil then
...
function HipotecarioUvaTnaEntity:match_get()
...
function HipotecarioUvaTnaEntity:stream(action, args, callopts)
...
---@param reqmatch HipotecarioUvaTnaListMatch
---@param ctrl? table
---@return HipotecarioUvaTna[]
---@return string? err
function HipotecarioUvaTnaEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function HipotecarioUvaTnaEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return HipotecarioUvaTnaEntity
