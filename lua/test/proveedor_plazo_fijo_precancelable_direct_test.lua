-- ProveedorPlazoFijoPrecancelable direct test
...
describe("ProveedorPlazoFijoPrecancelableDirect", function()
  it("should direct-list-proveedor_plazo_fijo_precancelable", function()
    local setup = proveedor_plazo_fijo_precancelable_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-proveedor_plazo_fijo_precancelable", setup.live and "live" or "unit")
...
function proveedor_plazo_fijo_precancelable_direct_setup(mockres)
