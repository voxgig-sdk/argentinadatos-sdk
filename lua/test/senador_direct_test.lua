...
describe("SenadorDirect", function()
  it("should direct-list-senador", function()
    local setup = senador_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-senador", setup.live and "live" or "unit")
...
function senador_direct_setup(mockres)
