...
describe("BonosCerDirect", function()
  it("should direct-list-bonos_cer", function()
    local setup = bonos_cer_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-bonos_cer", setup.live and "live" or "unit")
...
function bonos_cer_direct_setup(mockres)
