...
describe("LetraDirect", function()
  it("should direct-list-letra", function()
    local setup = letra_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-letra", setup.live and "live" or "unit")
...
function letra_direct_setup(mockres)
