...
describe("CriptopesoDirect", function()
  it("should direct-list-criptopeso", function()
    local setup = criptopeso_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-criptopeso", setup.live and "live" or "unit")
...
function criptopeso_direct_setup(mockres)
