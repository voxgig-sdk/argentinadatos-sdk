...
describe("IndiceInflacionDirect", function()
  it("should direct-list-indice_inflacion", function()
    local setup = indice_inflacion_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-indice_inflacion", setup.live and "live" or "unit")
...
function indice_inflacion_direct_setup(mockres)
