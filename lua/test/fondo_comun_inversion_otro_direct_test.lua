-- FondoComunInversionOtro direct test
...
describe("FondoComunInversionOtroDirect", function()
  it("should direct-load-fondo_comun_inversion_otro", function()
    local setup = fondo_comun_inversion_otro_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-fondo_comun_inversion_otro", setup.live and "live" or "unit")
...
function fondo_comun_inversion_otro_direct_setup(mockres)
