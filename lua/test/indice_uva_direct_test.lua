...
describe("IndiceUvaDirect", function()
  it("should direct-list-indice_uva", function()
    local setup = indice_uva_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-indice_uva", setup.live and "live" or "unit")
...
function indice_uva_direct_setup(mockres)
