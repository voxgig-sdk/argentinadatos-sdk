-- EntidadRendimiento direct test
...
describe("EntidadRendimientoDirect", function()
  it("should direct-list-entidad_rendimiento", function()
    local setup = entidad_rendimiento_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-entidad_rendimiento", setup.live and "live" or "unit")
...
function entidad_rendimiento_direct_setup(mockres)
