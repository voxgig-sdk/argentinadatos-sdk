...
describe("FinanzaDirect", function()
  it("should direct-list-finanza", function()
    local setup = finanza_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-finanza", setup.live and "live" or "unit")
...
function finanza_direct_setup(mockres)
