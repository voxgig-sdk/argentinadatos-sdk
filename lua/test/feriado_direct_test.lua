...
describe("FeriadoDirect", function()
  it("should direct-load-feriado", function()
    local setup = feriado_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-feriado", setup.live and "live" or "unit")
...
function feriado_direct_setup(mockres)
