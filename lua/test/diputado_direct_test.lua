...
describe("DiputadoDirect", function()
  it("should direct-list-diputado", function()
    local setup = diputado_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-diputado", setup.live and "live" or "unit")
...
function diputado_direct_setup(mockres)
