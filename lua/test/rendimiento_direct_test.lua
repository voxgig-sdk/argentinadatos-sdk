...
describe("RendimientoDirect", function()
  it("should direct-load-rendimiento", function()
    local setup = rendimiento_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rendimiento", setup.live and "live" or "unit")
...
function rendimiento_direct_setup(mockres)
