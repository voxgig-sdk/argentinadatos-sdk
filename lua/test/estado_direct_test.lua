...
describe("EstadoDirect", function()
  it("should direct-load-estado", function()
    local setup = estado_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-estado", setup.live and "live" or "unit")
...
function estado_direct_setup(mockres)
