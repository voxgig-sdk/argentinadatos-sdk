...
describe("TasaIntereDirect", function()
  it("should direct-list-tasa_intere", function()
    local setup = tasa_intere_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tasa_intere", setup.live and "live" or "unit")
...
function tasa_intere_direct_setup(mockres)
