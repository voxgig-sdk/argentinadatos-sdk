-- EventoPresidencial direct test
...
describe("EventoPresidencialDirect", function()
  it("should direct-list-evento_presidencial", function()
    local setup = evento_presidencial_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-evento_presidencial", setup.live and "live" or "unit")
...
function evento_presidencial_direct_setup(mockres)
