...
describe("TasaPlazoFijoDirect", function()
  it("should direct-list-tasa_plazo_fijo", function()
    local setup = tasa_plazo_fijo_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tasa_plazo_fijo", setup.live and "live" or "unit")
...
function tasa_plazo_fijo_direct_setup(mockres)
