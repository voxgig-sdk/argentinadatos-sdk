-- CuentaRemuneradaUsd direct test
...
describe("CuentaRemuneradaUsdDirect", function()
  it("should direct-list-cuenta_remunerada_usd", function()
    local setup = cuenta_remunerada_usd_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cuenta_remunerada_usd", setup.live and "live" or "unit")
...
function cuenta_remunerada_usd_direct_setup(mockres)
