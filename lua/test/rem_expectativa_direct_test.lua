...
describe("RemExpectativaDirect", function()
  it("should direct-list-rem_expectativa", function()
    local setup = rem_expectativa_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-rem_expectativa", setup.live and "live" or "unit")
...
function rem_expectativa_direct_setup(mockres)
