...
describe("HipotecarioUvaTnaDirect", function()
  it("should direct-list-hipotecario_uva_tna", function()
    local setup = hipotecario_uva_tna_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-hipotecario_uva_tna", setup.live and "live" or "unit")
...
function hipotecario_uva_tna_direct_setup(mockres)
