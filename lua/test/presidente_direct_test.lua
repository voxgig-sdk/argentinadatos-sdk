...
describe("PresidenteDirect", function()
  it("should direct-list-presidente", function()
    local setup = presidente_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-presidente", setup.live and "live" or "unit")
...
function presidente_direct_setup(mockres)
