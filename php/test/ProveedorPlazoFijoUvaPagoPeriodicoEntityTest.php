...
class ProveedorPlazoFijoUvaPagoPeriodicoEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->ProveedorPlazoFijoUvaPagoPeriodico(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->ProveedorPlazoFijoUvaPagoPeriodico(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $proveedor_plazo_fijo_uva_pago_periodico_ref01_list_result = $proveedor_plazo_fijo_uva_pago_periodico_ref01_ent->list($proveedor_plazo_fijo_uva_pago_periodico_ref01_match, null);
