...
class FinanzaDirectTest extends TestCase
{
    public function test_direct_list_finanza(): void
    {
        $setup = finanza_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-finanza", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
