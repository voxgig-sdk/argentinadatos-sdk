...
class EntidadRendimientoEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->EntidadRendimiento(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->EntidadRendimiento(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $entidad_rendimiento_ref01_list_result = $entidad_rendimiento_ref01_ent->list($entidad_rendimiento_ref01_match, null);
