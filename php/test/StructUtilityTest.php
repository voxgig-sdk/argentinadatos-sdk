...
// Argentinadatos SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ArgentinadatosOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ArgentinadatosOmni::structfix($now, Struct::undef()))
                        !== json_encode(ArgentinadatosOmni::structfix($val, Struct::undef()))) {
