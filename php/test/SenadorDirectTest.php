...
class SenadorDirectTest extends TestCase
{
    public function test_direct_list_senador(): void
    {
        $setup = senador_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-senador", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
