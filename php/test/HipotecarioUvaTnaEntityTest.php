...
class HipotecarioUvaTnaEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->HipotecarioUvaTna(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->HipotecarioUvaTna(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $hipotecario_uva_tna_ref01_list_result = $hipotecario_uva_tna_ref01_ent->list($hipotecario_uva_tna_ref01_match, null);
