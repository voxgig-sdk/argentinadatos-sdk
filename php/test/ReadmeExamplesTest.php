...
// Argentinadatos SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ArgentinadatosSDK::test)
...
{
    private const SDK_CLASS = 'ArgentinadatosSDK';
    ...
    private const SDK_BASE = 'argentinadatos_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../argentinadatos_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
