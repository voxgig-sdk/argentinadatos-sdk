...
// Argentinadatos SDK ratelimit feature
...
class ArgentinadatosRatelimitFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _acquire(ArgentinadatosContext $ctx): void
    {
    ...
    private function _track(ArgentinadatosContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
