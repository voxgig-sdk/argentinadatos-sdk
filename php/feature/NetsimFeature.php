...
// Argentinadatos SDK netsim feature
...
class ArgentinadatosNetsimFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _simulate(ArgentinadatosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ArgentinadatosContext $ctx, array $applied): void
    {
        $client = $this->client;
