...
// Argentinadatos SDK audit feature
...
class ArgentinadatosAuditFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _emit(ArgentinadatosContext $ctx, string $outcome): void
    {
