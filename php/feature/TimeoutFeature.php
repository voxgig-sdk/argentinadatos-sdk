...
// Argentinadatos SDK timeout feature
...
class ArgentinadatosTimeoutFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _with_timeout(ArgentinadatosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ArgentinadatosContext $_ctx, float $ms): void
    {
        $client = $this->client;
