...
// Argentinadatos SDK streaming feature
...
class ArgentinadatosStreamingFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _iterate(ArgentinadatosResult $result): \Generator
    {
    ...
    private function _streamable(ArgentinadatosContext $ctx): bool
    {
