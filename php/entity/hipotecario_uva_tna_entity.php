...
class HipotecarioUvaTnaEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "hipotecario_uva_tna";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new HipotecarioUvaTnaEntity($this->_client, $opts);
    }

    /**
     * @param HipotecarioUvaTna|array $args HipotecarioUvaTna data (assoc-array) to store.
     */
    ...
    /**
     * @return HipotecarioUvaTna|array The current HipotecarioUvaTna data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HipotecarioUvaTna fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HipotecarioUvaTna fields).
     */
    ...
    /**
     * List HipotecarioUvaTna items matching the given filter.
     *
     * @param HipotecarioUvaTnaListMatch|array|null $reqmatch Match filter (any subset
     *   of HipotecarioUvaTna fields) as an assoc-array; HipotecarioUvaTnaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HipotecarioUvaTna[]|array A list of HipotecarioUvaTna items as assoc-arrays at
