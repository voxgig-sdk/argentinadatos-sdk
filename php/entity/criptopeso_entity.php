...
// Argentinadatos SDK Criptopeso entity
...
class CriptopesoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CriptopesoEntity($this->_client, $opts);
    }

    /**
     * @param Criptopeso|array $args Criptopeso data (assoc-array) to store.
     */
    ...
    /**
     * @return Criptopeso|array The current Criptopeso data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Criptopeso fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Criptopeso fields).
     */
    ...
    /**
     * List Criptopeso items matching the given filter.
     *
     * @param CriptopesoListMatch|array|null $reqmatch Match filter (any subset
     *   of Criptopeso fields) as an assoc-array; CriptopesoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Criptopeso[]|array A list of Criptopeso items as assoc-arrays at
