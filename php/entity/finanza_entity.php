...
// Argentinadatos SDK Finanza entity
...
class FinanzaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FinanzaEntity($this->_client, $opts);
    }

    /**
     * @param Finanza|array $args Finanza data (assoc-array) to store.
     */
    ...
    /**
     * @return Finanza|array The current Finanza data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Finanza fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Finanza fields).
     */
    ...
    /**
     * List Finanza items matching the given filter.
     *
     * @param FinanzaListMatch|array|null $reqmatch Match filter (any subset
     *   of Finanza fields) as an assoc-array; FinanzaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Finanza[]|array A list of Finanza items as assoc-arrays at
