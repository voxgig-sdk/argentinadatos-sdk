...
// Argentinadatos SDK IndiceUva entity
...
class IndiceUvaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IndiceUvaEntity($this->_client, $opts);
    }

    /**
     * @param IndiceUva|array $args IndiceUva data (assoc-array) to store.
     */
    ...
    /**
     * @return IndiceUva|array The current IndiceUva data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IndiceUva fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IndiceUva fields).
     */
    ...
    /**
     * List IndiceUva items matching the given filter.
     *
     * @param IndiceUvaListMatch|array|null $reqmatch Match filter (any subset
     *   of IndiceUva fields) as an assoc-array; IndiceUvaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IndiceUva[]|array A list of IndiceUva items as assoc-arrays at
