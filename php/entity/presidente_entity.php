...
// Argentinadatos SDK Presidente entity
...
class PresidenteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PresidenteEntity($this->_client, $opts);
    }

    /**
     * @param Presidente|array $args Presidente data (assoc-array) to store.
     */
    ...
    /**
     * @return Presidente|array The current Presidente data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Presidente fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Presidente fields).
     */
    ...
    /**
     * List Presidente items matching the given filter.
     *
     * @param PresidenteListMatch|array|null $reqmatch Match filter (any subset
     *   of Presidente fields) as an assoc-array; PresidenteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Presidente[]|array A list of Presidente items as assoc-arrays at
