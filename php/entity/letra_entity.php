...
// Argentinadatos SDK Letra entity
...
class LetraEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LetraEntity($this->_client, $opts);
    }

    /**
     * @param Letra|array $args Letra data (assoc-array) to store.
     */
    ...
    /**
     * @return Letra|array The current Letra data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Letra fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Letra fields).
     */
    ...
    /**
     * List Letra items matching the given filter.
     *
     * @param LetraListMatch|array|null $reqmatch Match filter (any subset
     *   of Letra fields) as an assoc-array; LetraListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Letra[]|array A list of Letra items as assoc-arrays at
