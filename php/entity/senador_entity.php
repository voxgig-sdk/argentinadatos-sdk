...
// Argentinadatos SDK Senador entity
...
class SenadorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SenadorEntity($this->_client, $opts);
    }

    /**
     * @param Senador|array $args Senador data (assoc-array) to store.
     */
    ...
    /**
     * @return Senador|array The current Senador data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Senador fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Senador fields).
     */
    ...
    /**
     * List Senador items matching the given filter.
     *
     * @param SenadorListMatch|array|null $reqmatch Match filter (any subset
     *   of Senador fields) as an assoc-array; SenadorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Senador[]|array A list of Senador items as assoc-arrays at
