...
class RemExpectativaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RemExpectativaEntity($this->_client, $opts);
    }

    /**
     * @param RemExpectativa|array $args RemExpectativa data (assoc-array) to store.
     */
    ...
    /**
     * @return RemExpectativa|array The current RemExpectativa data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RemExpectativa fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RemExpectativa fields).
     */
    ...
    /**
     * List RemExpectativa items matching the given filter.
     *
     * @param RemExpectativaListMatch|array|null $reqmatch Match filter (any subset
     *   of RemExpectativa fields) as an assoc-array; RemExpectativaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RemExpectativa[]|array A list of RemExpectativa items as assoc-arrays at
