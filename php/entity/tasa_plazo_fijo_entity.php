...
// Argentinadatos SDK TasaPlazoFijo entity
...
class TasaPlazoFijoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TasaPlazoFijoEntity($this->_client, $opts);
    }

    /**
     * @param TasaPlazoFijo|array $args TasaPlazoFijo data (assoc-array) to store.
     */
    ...
    /**
     * @return TasaPlazoFijo|array The current TasaPlazoFijo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TasaPlazoFijo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TasaPlazoFijo fields).
     */
     ...
     *
     * @param TasaPlazoFijoListMatch|array|null $reqmatch Match filter (any subset
     *   of TasaPlazoFijo fields) as an assoc-array; TasaPlazoFijoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TasaPlazoFijo[]|array A list of TasaPlazoFijo items as assoc-arrays at
