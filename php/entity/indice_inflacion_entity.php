...
// Argentinadatos SDK IndiceInflacion entity
...
class IndiceInflacionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IndiceInflacionEntity($this->_client, $opts);
    }

    /**
     * @param IndiceInflacion|array $args IndiceInflacion data (assoc-array) to store.
     */
    ...
    /**
     * @return IndiceInflacion|array The current IndiceInflacion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IndiceInflacion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IndiceInflacion fields).
     */
     ...
     *
     * @param IndiceInflacionListMatch|array|null $reqmatch Match filter (any subset
     *   of IndiceInflacion fields) as an assoc-array; IndiceInflacionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IndiceInflacion[]|array A list of IndiceInflacion items as assoc-arrays at
