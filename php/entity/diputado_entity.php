...
// Argentinadatos SDK Diputado entity
...
class DiputadoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DiputadoEntity($this->_client, $opts);
    }

    /**
     * @param Diputado|array $args Diputado data (assoc-array) to store.
     */
    ...
    /**
     * @return Diputado|array The current Diputado data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Diputado fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Diputado fields).
     */
     ...
     *
     * @param DiputadoListMatch|array|null $reqmatch Match filter (any subset
     *   of Diputado fields) as an assoc-array; DiputadoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Diputado[]|array A list of Diputado items as assoc-arrays at
