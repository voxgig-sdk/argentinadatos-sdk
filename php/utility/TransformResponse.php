...
// Argentinadatos SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ArgentinadatosTransformResponse
{
    public static function call(ArgentinadatosContext $ctx): mixed
    {
        ...
        $transform = ArgentinadatosHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
