...
// Argentinadatos SDK utility: make_options

class ArgentinadatosMakeOptions
{
    ...
    public static function call(ArgentinadatosContext $ctx): array
    {
        ...
        //
        // `ArgentinadatosSchema::optspec()` is built from the model:
        ...
        $optspec = ArgentinadatosSchema::optspec();
