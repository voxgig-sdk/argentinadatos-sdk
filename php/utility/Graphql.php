...
// Argentinadatos SDK utility: graphql
//
...
class ArgentinadatosGraphql
{
    ...
    // equivalent.
    public static function body(ArgentinadatosContext $ctx): mixed
    {
    ...
    public static function errors(ArgentinadatosContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
