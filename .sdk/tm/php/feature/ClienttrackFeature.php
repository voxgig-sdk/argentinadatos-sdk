...
// Argentinadatos SDK clienttrack feature
...
class ArgentinadatosClienttrackFeature extends ArgentinadatosBaseFeature
{
    ...
    public function PostConstruct(ArgentinadatosContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Argentinadatos-SDK';
