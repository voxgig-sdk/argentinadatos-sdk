...
// Argentinadatos SDK proxy feature
...
class ArgentinadatosProxyFeature extends ArgentinadatosBaseFeature
{
    ...
    public function init(ArgentinadatosContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ArgentinadatosContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
