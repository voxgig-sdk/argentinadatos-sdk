...
// Argentinadatos SDK cache feature
...
class ArgentinadatosCacheFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _through(ArgentinadatosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
