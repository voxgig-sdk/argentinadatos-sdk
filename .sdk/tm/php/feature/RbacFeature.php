...
// Argentinadatos SDK rbac feature
...
class ArgentinadatosRbacFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _required(ArgentinadatosContext $ctx): ?string
    {
    ...
    private function _reject(ArgentinadatosContext $ctx, string $required): void
    {
    ...
    private function _track(ArgentinadatosContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
