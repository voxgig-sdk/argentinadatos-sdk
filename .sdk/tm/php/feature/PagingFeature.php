...
// Argentinadatos SDK paging feature
...
class ArgentinadatosPagingFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _is_list(ArgentinadatosContext $ctx): bool
    {
