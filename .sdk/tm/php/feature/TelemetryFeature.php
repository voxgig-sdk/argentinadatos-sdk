...
// Argentinadatos SDK telemetry feature
...
class ArgentinadatosTelemetryFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _close(ArgentinadatosContext $ctx, bool $ok): void
    {
