...
// Argentinadatos SDK metrics feature
...
class ArgentinadatosMetricsFeature extends ArgentinadatosBaseFeature
{
    ...
    private function _record(ArgentinadatosContext $ctx, bool $ok): void
    {
