...
// Argentinadatos SDK utility type

class ArgentinadatosUtility
{
    ...
    public static function copy(ArgentinadatosUtility $src): ArgentinadatosUtility
    {
        $u = new ArgentinadatosUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
