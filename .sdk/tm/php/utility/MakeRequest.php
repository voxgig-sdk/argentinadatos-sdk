...
// Argentinadatos SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ArgentinadatosMakeRequest
{
    public static function call(ArgentinadatosContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ArgentinadatosResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ArgentinadatosResponse($fetched);
        } else {
