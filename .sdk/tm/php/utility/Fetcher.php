...
// Argentinadatos SDK utility: fetcher
...
class ArgentinadatosFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ArgentinadatosSDK/1.0)';
    ...
    public static function call(ArgentinadatosContext $ctx, string $fullurl, array $fetchdef): array
    {
