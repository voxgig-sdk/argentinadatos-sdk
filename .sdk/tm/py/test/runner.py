...
class ArgentinadatosTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ArgentinadatosTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ArgentinadatosTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ArgentinadatosTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
...
def entity_data(v):
    return ArgentinadatosTestRunner.entity_data(v)
...
def live_client_options():
    return ArgentinadatosTestRunner.live_client_options()
