...
from projectname_sdk.core.control import ArgentinadatosControl
...
class ArgentinadatosContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ArgentinadatosControl()
        ...
        if isinstance(sp, ArgentinadatosSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ArgentinadatosResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ArgentinadatosResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ArgentinadatosOperation({})
    ...
    def make_error(self, code, msg):
        return ArgentinadatosError(code, msg, self)
