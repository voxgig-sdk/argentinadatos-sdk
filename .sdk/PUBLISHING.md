...
|---|---|---|
| `ts/` | @voxgig-sdk/argentinadatos-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/argentinadatos-sdk \
      --repository voxgig-sdk/argentinadatos-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/argentinadatos-sdk` shows it, and
`npm trust revoke @voxgig-sdk/argentinadatos-sdk --id=<id>` removes it.
