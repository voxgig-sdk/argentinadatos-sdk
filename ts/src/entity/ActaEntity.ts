...
class ActaEntity extends ArgentinadatosEntityBase<Acta> {
  ...
  make(this: ActaEntity) {
    return new ActaEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ActaLoadMatch, ctrl?: Control): Promise<ActaEntity> {
  ...
  async list(this: any, reqmatch?: ActaListMatch, ctrl?: Control): Promise<ActaEntity[]> {
