...
(0, node_test_1.describe)('DiputadoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-diputado', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-diputado', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_DIPUTADO_ENTID'];
...
//# sourceMappingURL=DiputadoDirect.test.js.map