...
(0, node_test_1.describe)('DiputadoEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/diputado/DiputadoTestData.json');
    ...
    let idmap = transform(['diputado01', 'diputado02', 'diputado03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['ARGENTINADATOS_TEST_DIPUTADO_ENTID'];
...
//# sourceMappingURL=DiputadoEntity.test.js.map