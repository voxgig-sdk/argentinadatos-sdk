...
(0, node_test_1.describe)('ProveedorPlazoFijoUvaPagoPeriodicoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ArgentinadatosSDK({
    ...
    (0, node_test_1.test)('direct-list-proveedor_plazo_fijo_uva_pago_periodico', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-proveedor_plazo_fijo_uva_pago_periodico', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ARGENTINADATOS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ArgentinadatosSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ARGENTINADATOS_TEST_PROVEEDOR_PLAZO_FIJO_UVA_PAGO_PERIODICO_ENTID'];
    ...
    const client = new __1.ArgentinadatosSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ProveedorPlazoFijoUvaPagoPeriodicoDirect.test.js.map