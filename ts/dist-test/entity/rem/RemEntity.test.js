...
(0, node_test_1.describe)('RemEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let rem_ref01_data = Object.values(setup.data.existing.rem)[0];
        // LIST
        const rem_ref01_ent = client.Rem();
        const rem_ref01_match = {};
        rem_ref01_match['año'] = setup.idmap['año01'];
        rem_ref01_match['mes'] = setup.idmap['mes01'];
        const rem_ref01_list = (await rem_ref01_ent.list(rem_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/rem/RemTestData.json');
    ...
    let idmap = transform(['rem01', 'rem02', 'rem03', 'rem01', 'rem02', 'rem03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RemEntity.test.js.map