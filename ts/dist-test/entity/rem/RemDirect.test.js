...
(0, node_test_1.describe)('RemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-rem', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-rem', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["año01", "mes01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_REM_ENTID'];
...
//# sourceMappingURL=RemDirect.test.js.map