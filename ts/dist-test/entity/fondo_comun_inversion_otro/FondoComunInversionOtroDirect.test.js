...
(0, node_test_1.describe)('FondoComunInversionOtroDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-fondo_comun_inversion_otro', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-fondo_comun_inversion_otro', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_FONDO_COMUN_INVERSION_OTRO_ENTID'];
...
//# sourceMappingURL=FondoComunInversionOtroDirect.test.js.map