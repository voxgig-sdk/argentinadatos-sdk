...
(0, node_test_1.describe)('BonosCerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-bonos_cer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-bonos_cer', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'ARGENTINADATOS_TEST_BONOS_CER_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_BONOS_CER_ENTID'];
...
//# sourceMappingURL=BonosCerDirect.test.js.map