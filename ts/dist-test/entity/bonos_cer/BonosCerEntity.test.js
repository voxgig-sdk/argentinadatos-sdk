...
(0, node_test_1.describe)('BonosCerEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/bonos_cer/BonosCerTestData.json');
    ...
    let idmap = transform(['bonos_cer01', 'bonos_cer02', 'bonos_cer03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BonosCerEntity.test.js.map