...
(0, node_test_1.describe)('TasaIntereDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-tasa_intere', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tasa_intere', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_TASA_INTERE_ENTID'];
...
//# sourceMappingURL=TasaIntereDirect.test.js.map