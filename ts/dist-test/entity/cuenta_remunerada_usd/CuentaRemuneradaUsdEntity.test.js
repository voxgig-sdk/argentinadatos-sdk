...
(0, node_test_1.describe)('CuentaRemuneradaUsdEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cuenta_remunerada_usd/CuentaRemuneradaUsdTestData.json');
    ...
    let idmap = transform(['cuenta_remunerada_usd01', 'cuenta_remunerada_usd02', 'cuenta_remunerada_usd03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CuentaRemuneradaUsdEntity.test.js.map