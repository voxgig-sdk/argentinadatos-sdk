...
(0, node_test_1.describe)('CuentaRemuneradaUsdDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-cuenta_remunerada_usd', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cuenta_remunerada_usd', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_CUENTA_REMUNERADA_USD_ENTID'];
...
//# sourceMappingURL=CuentaRemuneradaUsdDirect.test.js.map