...
(0, node_test_1.describe)('ProveedorPlazoFijoPrecancelableDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-proveedor_plazo_fijo_precancelable', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-proveedor_plazo_fijo_precancelable', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_PROVEEDOR_PLAZO_FIJO_PRECANCELABLE_ENTID'];
...
//# sourceMappingURL=ProveedorPlazoFijoPrecancelableDirect.test.js.map