...
(0, node_test_1.describe)('FeriadoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-feriado', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-feriado', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_FERIADO_ENTID'];
...
//# sourceMappingURL=FeriadoDirect.test.js.map