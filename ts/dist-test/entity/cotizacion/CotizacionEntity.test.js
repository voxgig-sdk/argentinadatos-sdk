...
(0, node_test_1.describe)('CotizacionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(cotizacion_ref01_data_dt0.id === cotizacion_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cotizacion/CotizacionTestData.json');
    ...
    let idmap = transform(['cotizacion01', 'cotizacion02', 'cotizacion03', 'dolare01', 'dolare02', 'dolare03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CotizacionEntity.test.js.map