...
(0, node_test_1.describe)('EstadoEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/estado/EstadoTestData.json');
    ...
    let idmap = transform(['estado01', 'estado02', 'estado03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['ARGENTINADATOS_TEST_ESTADO_ENTID'];
...
//# sourceMappingURL=EstadoEntity.test.js.map