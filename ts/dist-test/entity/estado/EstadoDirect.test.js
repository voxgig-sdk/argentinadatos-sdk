...
(0, node_test_1.describe)('EstadoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-estado', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-estado', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'ARGENTINADATOS_TEST_ESTADO_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_ESTADO_ENTID'];
...
//# sourceMappingURL=EstadoDirect.test.js.map