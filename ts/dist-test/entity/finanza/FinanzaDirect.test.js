...
(0, node_test_1.describe)('FinanzaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-finanza', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-finanza', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_FINANZA_ENTID'];
...
//# sourceMappingURL=FinanzaDirect.test.js.map