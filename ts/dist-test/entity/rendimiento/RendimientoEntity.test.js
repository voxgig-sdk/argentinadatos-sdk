...
(0, node_test_1.describe)('RendimientoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let rendimiento_ref01_data = Object.values(setup.data.existing.rendimiento)[0];
        // LOAD
        const rendimiento_ref01_ent = client.Rendimiento();
        const rendimiento_ref01_match_dt0 = {};
        rendimiento_ref01_match_dt0.id = rendimiento_ref01_data.id;
        const rendimiento_ref01_data_dt0 = (await rendimiento_ref01_ent.load(rendimiento_ref01_match_dt0)).data();
        (0, node_assert_1.default)(rendimiento_ref01_data_dt0.id === rendimiento_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/rendimiento/RendimientoTestData.json');
    ...
    let idmap = transform(['rendimiento01', 'rendimiento02', 'rendimiento03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RendimientoEntity.test.js.map