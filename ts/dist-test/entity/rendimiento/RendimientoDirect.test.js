...
(0, node_test_1.describe)('RendimientoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-rendimiento', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rendimiento', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'ARGENTINADATOS_TEST_RENDIMIENTO_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_RENDIMIENTO_ENTID'];
...
//# sourceMappingURL=RendimientoDirect.test.js.map