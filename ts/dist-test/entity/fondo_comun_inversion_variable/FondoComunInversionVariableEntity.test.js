...
(0, node_test_1.describe)('FondoComunInversionVariableEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'fondo_comun_inversion_variable.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['ARGENTINADATOS_TEST_FONDO_COMUN_INVERSION_VARIABLE_ENTID'];
