...
(0, node_test_1.describe)('FondoComunInversionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-fondo_comun_inversion', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-fondo_comun_inversion', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_FONDO_COMUN_INVERSION_ENTID'];
...
//# sourceMappingURL=FondoComunInversionDirect.test.js.map