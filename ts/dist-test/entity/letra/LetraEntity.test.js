...
(0, node_test_1.describe)('LetraEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/letra/LetraTestData.json');
    ...
    let idmap = transform(['letra01', 'letra02', 'letra03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=LetraEntity.test.js.map