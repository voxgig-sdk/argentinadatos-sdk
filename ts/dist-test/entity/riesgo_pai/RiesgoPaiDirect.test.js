...
(0, node_test_1.describe)('RiesgoPaiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-riesgo_pai', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-riesgo_pai', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-riesgo_pai', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-riesgo_pai', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_RIESGO_PAI_ENTID'];
...
//# sourceMappingURL=RiesgoPaiDirect.test.js.map