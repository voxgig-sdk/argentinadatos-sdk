...
(0, node_test_1.describe)('RiesgoPaiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'riesgo_pai.' + op, live))
                return;
        }
        ...
        let riesgo_pai_ref01_data = Object.values(setup.data.existing.riesgo_pai)[0];
        // LIST
        const riesgo_pai_ref01_ent = client.RiesgoPai();
        const riesgo_pai_ref01_match = {};
        const riesgo_pai_ref01_list = (await riesgo_pai_ref01_ent.list(riesgo_pai_ref01_match)).map((e) => e.data());
        // LOAD
        const riesgo_pai_ref01_match_dt0 = {};
        const riesgo_pai_ref01_data_dt0 = (await riesgo_pai_ref01_ent.load(riesgo_pai_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != riesgo_pai_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/riesgo_pai/RiesgoPaiTestData.json');
    ...
    let idmap = transform(['riesgo_pai01', 'riesgo_pai02', 'riesgo_pai03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RiesgoPaiEntity.test.js.map