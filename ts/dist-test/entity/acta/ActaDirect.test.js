...
(0, node_test_1.describe)('ActaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-acta', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-acta', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-acta', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-acta', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'ARGENTINADATOS_TEST_ACTA_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_ACTA_ENTID'];
...
//# sourceMappingURL=ActaDirect.test.js.map