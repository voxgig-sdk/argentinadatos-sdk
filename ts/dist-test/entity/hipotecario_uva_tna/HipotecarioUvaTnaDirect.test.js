...
(0, node_test_1.describe)('HipotecarioUvaTnaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-hipotecario_uva_tna', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-hipotecario_uva_tna', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ARGENTINADATOS_TEST_HIPOTECARIO_UVA_TNA_ENTID'];
...
//# sourceMappingURL=HipotecarioUvaTnaDirect.test.js.map