...
(0, node_test_1.describe)('HipotecarioUvaTnaEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let hipotecario_uva_tna_ref01_data = Object.values(setup.data.existing.hipotecario_uva_tna)[0];
        // LIST
        const hipotecario_uva_tna_ref01_ent = client.HipotecarioUvaTna();
        const hipotecario_uva_tna_ref01_match = {};
        const hipotecario_uva_tna_ref01_list = (await hipotecario_uva_tna_ref01_ent.list(hipotecario_uva_tna_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/hipotecario_uva_tna/HipotecarioUvaTnaTestData.json');
    ...
    let idmap = transform(['hipotecario_uva_tna01', 'hipotecario_uva_tna02', 'hipotecario_uva_tna03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=HipotecarioUvaTnaEntity.test.js.map