...
function envOverride(m) {
    if ('TRUE' === process.env.ARGENTINADATOS_TEST_LIVE ||
        'TRUE' === process.env.ARGENTINADATOS_TEST_OVERRIDE) {
    ...
    m.ARGENTINADATOS_TEST_EXPLAIN = process.env.ARGENTINADATOS_TEST_EXPLAIN || m.ARGENTINADATOS_TEST_EXPLAIN;
    return m;
}
