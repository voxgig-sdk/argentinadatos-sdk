...
describe('DiputadoEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let diputado_ref01_data = Object.values(setup.data.existing.diputado)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/diputado/DiputadoTestData.json')
