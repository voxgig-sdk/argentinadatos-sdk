...
describe('ProveedorPlazoFijoPrecancelableEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const proveedor_plazo_fijo_precancelable_ref01_list = await proveedor_plazo_fijo_precancelable_ref01_ent.list(proveedor_plazo_fijo_precancelable_ref01_match)
