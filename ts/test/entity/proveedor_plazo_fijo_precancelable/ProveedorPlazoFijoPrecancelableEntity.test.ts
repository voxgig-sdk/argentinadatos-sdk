...
describe('ProveedorPlazoFijoPrecancelableEntity', async () => {
  ...
  test('instance', async () => {
    ...
    const ent = testsdk.ProveedorPlazoFijoPrecancelable()
    assert(null != ent)
  })
  ...
  test('basic', async (t) => {
    ...
    let proveedor_plazo_fijo_precancelable_ref01_data = Object.values(setup.data.existing.proveedor_plazo_fijo_precancelable)[0] as any

    // LIST
    const proveedor_plazo_fijo_precancelable_ref01_ent = client.ProveedorPlazoFijoPrecancelable()
    const proveedor_plazo_fijo_precancelable_ref01_match: any = {}

    const proveedor_plazo_fijo_precancelable_ref01_list = (await proveedor_plazo_fijo_precancelable_ref01_ent.list(proveedor_plazo_fijo_precancelable_ref01_match)).map((e: any) => e.data())
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/proveedor_plazo_fijo_precancelable/ProveedorPlazoFijoPrecancelableTestData.json')
