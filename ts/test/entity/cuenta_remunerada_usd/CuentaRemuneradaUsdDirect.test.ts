...
describe('CuentaRemuneradaUsdDirect', async () => {
  ...
  test('direct-list-cuenta_remunerada_usd', async (t: any) => {
    if (liveScenariosActive()) { t.skip('Covered by live operation scenarios'); return }
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-cuenta_remunerada_usd', setup.live)) return
