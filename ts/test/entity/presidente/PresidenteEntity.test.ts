...
describe('PresidenteEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const presidente_ref01_list = (await presidente_ref01_ent.list(presidente_ref01_match)).map((e: any) => e.data())
