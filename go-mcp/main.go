// Command Argentinadatos-mcp is an MCP server exposing the Argentinadatos
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Argentinadatos_list  — list records of an entity
//	Argentinadatos_load  — load a single record of an entity
//
