# Argentinadatos SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ArgentinadatosSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ArgentinadatosSDK(...) and ArgentinadatosSDK.test(...) become
#      ArgentinadatosSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "argentinadatos_sdk"
_SDK_CLASS = "ArgentinadatosSDK"
...
_ENTITIES = {
    ...
    "Criptopeso": "criptopeso",
    "CuentaRemuneradaUsd": "cuenta_remunerada_usd",
    "Diputado": "diputado",
    "EntidadRendimiento": "entidad_rendimiento",
    "Estado": "estado",
    "EventoPresidencial": "evento_presidencial",
    "Feriado": "feriado",
    "Finanza": "finanza",
    "FondoComunInversion": "fondo_comun_inversion",
    "FondoComunInversionOtro": "fondo_comun_inversion_otro",
    "FondoComunInversionVariable": "fondo_comun_inversion_variable",
    "HipotecarioUvaTna": "hipotecario_uva_tna",
    "IndiceInflacion": "indice_inflacion",
    "IndiceUva": "indice_uva",
    "Letra": "letra",
    "Presidente": "presidente",
    "ProveedorPlazoFijoPrecancelable": "proveedor_plazo_fijo_precancelable",
    "ProveedorPlazoFijoUvaPagoPeriodico": "proveedor_plazo_fijo_uva_pago_periodico",
    "Rem": "rem",
    "RemExpectativa": "rem_expectativa",
    "Rendimiento": "rendimiento",
    "RiesgoPai": "riesgo_pai",
    "Senador": "senador",
    "TasaIntere": "tasa_intere",
    "TasaPlazoFijo": "tasa_plazo_fijo",
}
