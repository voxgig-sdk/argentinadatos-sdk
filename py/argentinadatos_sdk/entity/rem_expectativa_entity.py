...
class RemExpectativaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RemExpectativaEntity(self._client, opts)
    ...
    def data_get(self) -> RemExpectativa:
    ...
    def match_get(self) -> RemExpectativa:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RemExpectativa]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RemExpectativa().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
