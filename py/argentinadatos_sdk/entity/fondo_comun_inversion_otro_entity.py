...
class FondoComunInversionOtroEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FondoComunInversionOtroEntity(self._client, opts)
    ...
    def data_get(self) -> FondoComunInversionOtro:
    ...
    def match_get(self) -> FondoComunInversionOtro:
    ...
    def load(self, reqmatch=None, ctrl=None) -> FondoComunInversionOtro:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.FondoComunInversionOtro().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
