...
class FondoComunInversionVariableEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FondoComunInversionVariableEntity(self._client, opts)
    ...
    def data_get(self) -> FondoComunInversionVariable:
    ...
    def match_get(self) -> FondoComunInversionVariable:
    ...
    def load(self, reqmatch=None, ctrl=None) -> FondoComunInversionVariable:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.FondoComunInversionVariable().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
