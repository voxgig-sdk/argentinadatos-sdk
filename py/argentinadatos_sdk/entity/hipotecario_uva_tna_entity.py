...
class HipotecarioUvaTnaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HipotecarioUvaTnaEntity(self._client, opts)
    ...
    def data_get(self) -> HipotecarioUvaTna:
    ...
    def match_get(self) -> HipotecarioUvaTna:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[HipotecarioUvaTna]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.HipotecarioUvaTna().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
