...
class BonosCerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BonosCerEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BonosCer]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BonosCer().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
