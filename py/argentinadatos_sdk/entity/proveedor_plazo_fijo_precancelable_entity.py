...
from argentinadatos_sdk.argentinadatos_types import (
    ...
    ProveedorPlazoFijoPrecancelableListMatch,
)
...
class ProveedorPlazoFijoPrecancelableEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProveedorPlazoFijoPrecancelableEntity(self._client, opts)
    ...
    def data_get(self) -> ProveedorPlazoFijoPrecancelable:
    ...
    def match_get(self) -> ProveedorPlazoFijoPrecancelable:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ProveedorPlazoFijoPrecancelable]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ProveedorPlazoFijoPrecancelable().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
