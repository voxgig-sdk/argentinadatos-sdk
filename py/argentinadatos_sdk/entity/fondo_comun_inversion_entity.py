...
class FondoComunInversionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FondoComunInversionEntity(self._client, opts)
    ...
    def data_get(self) -> FondoComunInversion:
    ...
    def match_get(self) -> FondoComunInversion:
    ...
    def load(self, reqmatch=None, ctrl=None) -> FondoComunInversion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.FondoComunInversion().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
