...
class RendimientoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RendimientoEntity(self._client, opts)
    ...
    def match_get(self) -> Rendimiento:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Rendimiento:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Rendimiento().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
