...
from argentinadatos_sdk.argentinadatos_types import (
    ProveedorPlazoFijoUvaPagoPeriodico,
    ProveedorPlazoFijoUvaPagoPeriodicoListMatch,
)
...
class ProveedorPlazoFijoUvaPagoPeriodicoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProveedorPlazoFijoUvaPagoPeriodicoEntity(self._client, opts)
    ...
    def data_get(self) -> ProveedorPlazoFijoUvaPagoPeriodico:
    ...
    def match_get(self) -> ProveedorPlazoFijoUvaPagoPeriodico:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ProveedorPlazoFijoUvaPagoPeriodico]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ProveedorPlazoFijoUvaPagoPeriodico().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
