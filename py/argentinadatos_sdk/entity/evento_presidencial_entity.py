...
class EventoPresidencialEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EventoPresidencialEntity(self._client, opts)
    ...
    def data_get(self) -> EventoPresidencial:
    ...
    def match_get(self) -> EventoPresidencial:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EventoPresidencial]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EventoPresidencial().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
