...
class TasaPlazoFijoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TasaPlazoFijoEntity(self._client, opts)
    ...
    def data_get(self) -> TasaPlazoFijo:
    ...
    def match_get(self) -> TasaPlazoFijo:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TasaPlazoFijo]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TasaPlazoFijo().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
